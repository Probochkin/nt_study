Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=username", "Value=lala", ENDITEM, 
		"Name=password", "Value=ololo", ENDITEM, 
		"Name=passwordConfirm", "Value=ololo", ENDITEM, 
		"Name=firstName", "Value=Lala", ENDITEM, 
		"Name=lastName", "Value=Pird", ENDITEM, 
		"Name=address1", "Value=hz", ENDITEM, 
		"Name=address2", "Value=kuda", ENDITEM, 
