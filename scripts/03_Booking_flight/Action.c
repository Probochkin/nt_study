Action()
{
	...
	lr_start_transaction("03_Booking_flight");
...
lr_end_transaction("find_flight",LR_AUTO);
	...
	lr_start_transaction("choosing_flight");
	
	web_reg_find("Text=Payment Details",LAST);
	lr_save_string(lr_paramarr_random("outboundFlight"),"randOutBoundFlight");
	...
	lr_end_transaction("choosing_flight",LR_AUTO);
	...
	lr_start_transaction("paymant_details");

	
	
	web_reg_find("Text=leaves {randCityDepart}  for {randCityArrival}.",LAST);
	...
	lr_end_transaction("paymant_details",LR_AUTO);
	

	
lr_end_transaction("03_Booking_flight",LR_AUTO);
